...
session_start();
 ...
 <head>
   <meta charset="utf-8">
   <title>MoviesBaba-Account</title>
      ...
      echo"  <form  action='update.php' method='POST'>
          ...
          <input type='text' class='from-control' placeholder='Enter Date of Birth' name='dob' value='".$result['DOB']."'><br>
              ...
              <div class='signupbutton'>
                <br><br>
                <button type='submit' class='btn btn-outline-danger' name='sub' value='submit'>Update Details</button>
              ...
              <form class='' action='updatep.php' method='post'>
                ...
                <button type='submit' class=btn btn-outline-danger' name='subpass' value='submit'>Update Password</button><br>
